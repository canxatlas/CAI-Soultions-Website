...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      'inline-flex h-12 items-center justify-center rounded-xl bg-gray-800/50 p-1 text-gray-400',
      className
    )}
    {...props}
  />
